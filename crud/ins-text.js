...
let sql =
  ...
  +',"色覚異常では赤・青・緑のいずれかが感じづらくなるため、それらの色は色が近い別の色で代用しましょう。例えば、赤色を使いたい場合は、赤そのものではなく朱色や橙色等を使用しましょう。")'
  //1b
  ...
  +',"彩度の観点から、区別がつきやすくなっています。彩度の高い色と低い色で対比するか、彩度の高い色同士で対比することで区別がつきやすくなります。"'
