...
let sql =
  ...
  +',"色相の観点から、区別しやすい配色となっています。２部で学習したように、明度に差をつける等の方法でも区別しやすくなります"'
  +',"色相の観点から、区別がしづらい配色があります。別色覚視点を確認し、修正しましょう。色の選び方は、２部で学習できます。"'
  +',"別色覚視点を確認し、修正しましょう。")'
  //3b
  ...
  +',"項目名をまとめてグラフの外に表示すると、色にやる判別がつきづらい色覚では、どの線に対応しているか判別しづらくなる場合があります。"'
  +',"それぞれの線の近くに項目名を表示し、対応関係がわかりやすいようにしましょう。")'
  //
  +';';
