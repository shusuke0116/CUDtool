...
let sql =
  ...
  + `,("明るめの橙","FFBF33","E3D42D","ECDB21","FF9A96")`    //9
  + `,("暗めの橙","99721E","837801","94890B","8F4E4B")`    //10
  + `,("明るめの緑","31FC31","FFF14D","FFF04B","54B5FF")`   //11
  + `,("暗めの緑","198019","837C2A","8B8223","2A6C9E")`   //12
  + `,("ピンク","FFBFC0","C7C7C7","DADADA","FFC7BC")`    //13
  + `,("水色","C1C1FF","BFD1FF","C1D3FF","5C677A")`    //14
  + `;`;
